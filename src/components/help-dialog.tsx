        ...
        <ScrollArea className="max-h-[60vh] pr-6">
            <div className="space-y-6 text-sm text-muted-foreground">
                <section>
                    ...
                    <p>
                        This application allows you to have conversations with your documents.
                ...
                <section>
                    ...
                    <ol className="list-decimal list-inside space-y-2">
                        ...
                        <li>
                            <strong className="font-medium text-foreground">Upload Documents:</strong> Go to the <code className="bg-muted px-1 py-0.5 rounded">Files</code> page. Drag and drop your PDF, DOCX, TXT, or CSV files into the upload area or click to select them. The app will process each file, extract the text, and add it to its knowledge base.
                        </li>
                        <li>
                ...
                <section>
                    ...
                    <p className="mt-2">
                        This application is provided "as is" without any warranty. By using this app, you agree that you cannot make any legal claims against its creators.
                    </p>
                    <p className="mt-2">
